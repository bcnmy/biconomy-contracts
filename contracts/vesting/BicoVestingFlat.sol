...
// File @openzeppelin/contracts/security/ReentrancyGuard.sol@v3.4.2
...
contract BicoVesting is AccessProtected, Pausable, ReentrancyGuard {
    using SafeMath for uint256;
    ...
    function createClaim(
        ...
        //review
        //should probably use IERC20 interface instead of ERC20 import?
        //need for safe transfer?

        //notice
        //Admin needs to give prior apporve tokens to this contract
        require(
